    ...
    public partial class OrderModuleForm : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtCId.Text == "")
                {
                    MessageBox.Show("Mohon pilih pelanggan!", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (txtPid.Text == "")
                {
                ...
                if (MessageBox.Show("Apakah kamu yakin ingin memasukkan pesanan ini?", "Simpan Pesanan", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Pesanan telah berhasil dimasukkan.");
