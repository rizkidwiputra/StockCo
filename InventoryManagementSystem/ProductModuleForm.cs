    ...
    public partial class ProductModuleForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Kamu yakin ingin menyimpan produk ini?", "Simpan Produk", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Produk telah berhasil disimpan!");
                    Clear();
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Kamu yakin ingin memperbarui produk ini?", "Perbarui Produk", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Produk telah berhasil diperbarui!");
                    this.Dispose();
                }
