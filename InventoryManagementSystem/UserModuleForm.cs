    ...
    public partial class UserModuleForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Kamu yakin ingin menyimpan pengguna ini?", "Simpan Pengguna",MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Pengguna telah berhasil disimpan.");
                    Clear();
                }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Kamu yakin perbarui pengguna ini?", "Perbarui Pengguna", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    con.Close();
                    MessageBox.Show("Pengguna telah berhasil diperbarui!");
                    this.Dispose();
                }
